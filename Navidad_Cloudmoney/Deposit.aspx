<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Deposit.aspx.cs" Inherits="Navidad_Cloudmoney.Deposit" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CloudMoney | Deposit</title>
...
<form id="form1" runat="server">
  ...
  <header>
    ...
    <nav class="navbar">
      <ul>
        <li><a href="Deposit.aspx" class="nav-active">Deposit</a></li>
  ...
  <main class="container">
    ...
    <div class="layout">
      ...
      <div class="left-panel">
        ...
        <div class="info-card">
          <div class="info-title">Deposit Rules</div>
          <ul class="info-list">
            <li>
            ...
            <li>
              <span class="info-icon">↓</span>
              <span>Maximum deposit: <strong>₱2,000</strong></span>
            </li>
            <li>
              <span class="info-icon">÷</span>
            ...
            <li>
              <span class="info-icon">⊙</span>
              <span>Balance cap: <strong>₱10,000</strong></span>
            </li>
          </ul>
        </div>
      ...
      <div class="right-panel">
        <div class="action-card">
          ...
          <div class="card-heading">Enter Deposit Amount</div>
          ...
          <div class="input-group">
            ...
            <asp:RequiredFieldValidator ID="rfvDamount" runat="server"
              ControlToValidate="txtDAmount"
              ErrorMessage="Amount is required."
              CssClass="val-msg" Display="Dynamic" />
          </div>

          <asp:Button ID="btDeposit" runat="server"
            Text="Deposit Now"
            CssClass="action-btn"
            OnClick="btDeposit_Click" />

          <asp:Label ID="lblMessage_Deposit" runat="server" CssClass="result-msg" />
