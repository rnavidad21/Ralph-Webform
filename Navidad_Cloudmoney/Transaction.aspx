<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transaction.aspx.cs" Inherits="Navidad_Cloudmoney.Transaction" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CloudMoney | Transactions</title>
...
<form id="form1" runat="server">
  ...
  <header>
    ...
    <nav class="navbar">
      <ul>
        ...
        <li><a href="Transaction.aspx" class="nav-active">Transactions</a></li>
  ...
  <main class="container">
    <div class="greeting">Money movement</div>
    <h1 class="page-title">My Sent & Received Transactions</h1>
      ...
      <div class="table-wrap">
        <div class="viewTransactions">
          <asp:GridView ID="gvTransactions" runat="server" AutoGenerateColumns="false"
              CssClass="stmt-table" GridLines="None"
              RowStyle-CssClass="row-even" AlternatingRowStyle-CssClass="row-odd">
            <Columns>
              <asp:BoundField DataField="SeqNo" HeaderText="Seq. #" ItemStyle-CssClass="seq-cell" />
              <asp:BoundField DataField="DateSent" HeaderText="Date Sent" DataFormatString="{0:MM/dd/yyyy HH:mm tt}" HtmlEncode="false" ItemStyle-CssClass="date-cell" />
              <asp:BoundField DataField="Amount" HeaderText="Amount" DataFormatString="₱{0:N2}" HtmlEncode="false" ItemStyle-CssClass="amount-cell" />
              <asp:BoundField DataField="SentTo" HeaderText="Sent To" ItemStyle-CssClass="ref-cell" />
              <asp:BoundField DataField="Received_From" HeaderText="Received From" ItemStyle-CssClass="ref-cell" />
            </Columns>
          </asp:GridView>
        </div>
      </div>
